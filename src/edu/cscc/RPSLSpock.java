...
public class RPSLSpock {
    ...
    /**
     *
      * @param pick user's pick
     * @return boolean if the user picked a valid choice
     */
    ...
    /**
     * @param pick computer's pick generated by a random number
     * @return the randomized pick
     */
    ...
    /**
     *
     * @param c_pick computers generated pick
     * @param h_pick users valid pick
     *
     * using the rules of rock paper scissors lizard spock, determines who wins
     *
     * @return a boolean set to true if the computer beat the user
     */
